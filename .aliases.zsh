...
alias openmkt='cd ~/Projects/mkt_news && code .'
alias openfsm='cd ~/Projects/web_fsm_production && code .'
alias openfull='cd ~/Projects && code .'
# change directory
alias gop='cd ~/Projects'
alias gom='cd ~/Projects/mkt_news/'
alias gomb='cd ~/Projects/mkt_news/backend'
alias gomf='cd ~/Projects/mkt_news/frontend'
